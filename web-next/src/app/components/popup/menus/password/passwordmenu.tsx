    ...
    return (
        <div className={styles.main}>
            { menu === Menu.VERIFICATION_CODE ?
                <CodeMenu submitCallback={() => setMenu(Menu.PASSWORD)} verificationCodeSetter={setVerificationCode} />
            :
                <PasswordMenu submitCallback={handleClick} passwordSetter={setPassword} confirmPasswordSetter={setConfirmPassword} />
            }
        </div>
    );
}
...
function CodeMenu(props: CodeMenuProps) {
    ...
    return (
        <div>
            ...
            <input className={styles.code} type='text' placeholder='Verification code' required onChange={e => {
...
function PasswordMenu (props: PasswordMenuProps) {
    return (
        <div>
            <input className={styles.password} type='password' placeholder='New password' required onChange={e => props.passwordSetter(e.target.value)} />
            <input className={styles.password} type='password' placeholder='Confirm password' required onChange={e => props.confirmPasswordSetter(e.target.value)} />
